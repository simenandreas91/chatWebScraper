...
def main():
    ...
    ap.add_argument("--out-xlsx", default="spreadsheets/client_scripts.xlsx", help="Output .xlsx filename")
    ap.add_argument("--out-csv", default="spreadsheets/client_scripts.csv", help="Output .csv filename")
    args = ap.parse_args()
