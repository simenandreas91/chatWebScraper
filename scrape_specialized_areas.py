...
def main():
    ...
    ap.add_argument("--out", default="spreadsheets/specialized_areas.xlsx", help="Output .xlsx filename")
    args = ap.parse_args()
    ...
    print(f"Saved {len(df)} specialized areas to {xlsx_path} and {csv_path}")
