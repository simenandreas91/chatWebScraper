...
def main():
    ...
    ap.add_argument("--out", default="spreadsheets/transform_map_scripts.xlsx", help="Output .xlsx filename")
    args = ap.parse_args()
    ...
    print(f"Saved {len(df)} transform map scripts to {xlsx_path} and {csv_path}")
