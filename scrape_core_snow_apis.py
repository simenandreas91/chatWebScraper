...
def main():
    ...
    ap.add_argument("--out", default="spreadsheets/core_snow_apis.xlsx", help="Output .xlsx filename")
    args = ap.parse_args()
    ...
    print(f"Saved {len(df)} core ServiceNow APIs to {xlsx_path} and {csv_path}")
