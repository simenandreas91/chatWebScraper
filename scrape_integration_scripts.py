...
def main():
    ...
    ap.add_argument("--out", default="spreadsheets/integration_scripts.xlsx", help="Output .xlsx filename")
    args = ap.parse_args()
    ...
    print(f"Saved {len(df)} integration scripts to {xlsx_path} and {csv_path}")
